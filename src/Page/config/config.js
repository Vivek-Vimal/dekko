...
export const CardData = [
    {bg:"linear-gradient(to right, #ffe000, #799f0c)", img:"/princedonnell.jpg", name:"@PrinceDonnell", desc:"Founder of Jumping Jack Taxes & Visionary behind Dekko Heroes"},
    {
        bg:"linear-gradient(to right, #ffe000, #799f0c)", img:"/mrpolishedd.jpg", name:"@mrpolishedd", desc:"Administrator & Community Builder Behind Dekko Heroes"
    },
    {bg:"linear-gradient(to right, #ffe000, #799f0c)",img:"/racso.jpg", name:"@racso_nft", desc:"Administrator & Community Builder Behind Dekko Heroes"},
    {bg:"linear-gradient(to right, #ffe000, #799f0c)", img:"/highdreams.jpg", name:"@highdreams_art", desc:"Creative Artist behind Dekko Heroes"}
];

export const CardData1 = [

    {bg:"linear-gradient(to right, #ffe000, #799f0c)",img:None,name:"@PrinceDonnell",desc:"The world's oldest and largest corporation has survived the apocalypse to develop DADs that take the best of traditional warfare vehicles to the next level.", details:"",rbtn:"GROUND",rbg:"#91705f",rank:"05", isSale:false,main: false},
    ...
    // {bg:"linear-gradient(to right, #add100, #7b920a)",img:Mothercow,name:"Invictus",desc:" The so-called “4 Horsemen of the Apocalypse” are the supreme leaders of this faction and revered as visionaries. Their DADs use a mysterious technology that gives them unique tactical advantages.", details:"",rbtn:"GROUND",rbg:"#91705f",rank:"07", isSale:false,main: false},
